...
// class ComeThroughLinkView extends StatefulWidget {
//   final String uuid;
//   const ComeThroughLinkView({required this.uuid, super.key});

//   @override
//   State<ComeThroughLinkView> createState() => _ComeThroughLinkViewState();
// }

// class _ComeThroughLinkViewState extends State<ComeThroughLinkView> {
...
//           if (!controller.isloading && productModel == null) {
//             productModel =
//                 controller.allProducts.firstWhere((e) => e.uuid == widget.uuid);
//           }
//           return SizedBox();
...
//           //                             _productImageIndex.value], // Replace with
...
//           //                   children: [
//           //                     ...List.generate(productModel.images.length,
//           //                         (index) {
...
//           //                           decoration: BoxDecoration(
//           //                               border: Border.all(
//           //                                   color: _productImageIndex.value ==
//           //                                           index
...
//           //                             text:
//           //                                 "$currentUrl/product/${productModel.uuid}"));
//           //                       },
//           //                       icon: const Icon(
//           //                         Icons.share,
//           //                         color: Colors.black,
...
//           //                     starSize: 15,
//           //                   ),
//           //                   Text(" (${productModel.totalrating})"),
//           //                 ],
//           //               ),
//           //               styleSheet.SPACING.addHeight(styleSheet.SPACING.medium),

//           //               // Price Section
//           //               if (productModel.variant.isEmpty)
//           //                 Row(
//           //                   children: [
//           //                     Text(
...
//           //                     children: [
//           //                       Text(
//           //                         'Rs. ${productModel.variant[designController.initialSize.value].finalprice}',
//           //                         style: styleSheet.TEXT_Rubik.FS_MEDIUM_24,
//           //                       ),
//           //                       styleSheet.SPACING
//           //                           .addWidth(styleSheet.SPACING.small),
//           //                       Text(
//           //                         'Rs. ${productModel.variant[designController.initialSize.value].price}',
//           //                         style: const TextStyle(
//           //                           fontSize: 18,
//           //                           color: Colors.grey,
//           //                           decoration: TextDecoration.lineThrough,
...
//           //               if (productModel.variant.length > 1)
//           //                 Column(
//           //                   crossAxisAlignment: CrossAxisAlignment.start,
//           //                   children: [
//           //                     Text("SELECT VARIANT"),
...
//           //                           children: [
//           //                             ...List.generate(
//           //                                 productModel.variant.length, (index) {
//           //                               return GestureDetector(
//           //                                 onTap: () {
...
//           //                                   ),
//           //                                   child: Text(
//           //                                     productModel.variant[index].title,
//           //                                     style: TextStyle(
//           //                                         color: designController
//           //                                                     .initialSize
//           //                                                     .value ==
...
//           //               if (productModel.isImageRequired)
//           //                 Column(
//           //                   crossAxisAlignment: CrossAxisAlignment.start,
//           //                   children: [
...
//           //                       hintText:
//           //                           "Any message you want to print on it..",
//           //                     ),
//           //                     styleSheet.SPACING
//           //                         .addHeight(styleSheet.SPACING.large),
...
//           //                             Container(
//           //                               padding:
//           //                                   styleSheet.SPACING.PADDING_SMALL,
//           //                               decoration: BoxDecoration(
...
//           //                           } else if (productModel.isImageRequired &&
//           //                               _imageData == null) {
//           //                             Get.snackbar(
...
//           //                   style: styleSheet.TEXT_Rubik.FS_MEDIUM_15.copyWith(
//           //                       color: styleSheet.COLORS.ACTIVE_GREEN),
//           //                 ),
//           //               ),
//           //               styleSheet.SPACING.addHeight(styleSheet.SPACING.medium),
...
//           //                 children: [Text(productModel.description)],
//           //               ),
...
//           //                 alignment: Alignment.center,
//           //                 child: Text(
//           //                   "Based on ${productModel.totalrating} reviews",
...
//           //                 List<NewProductModel> youmayLikeProducts = product
//           //                     .allProducts
//           //                     .where((e) =>
//           //                         e.categoryID == productModel.categoryID)
//           //                     .toList();
...
//           //                             .nextInt(product.allProducts.length - 1)];
//           //                     return InkWell(
//           //                       onTap: () => Get.to(() =>
